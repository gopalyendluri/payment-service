...
namespace PaymentService\ServiceProvider\Provider\Stripe\Connector;

use PaymentService\ServiceProvider\Connector\RESTConnector;
use PaymentService\ServiceProvider\Provider\Stripe\Request;
use PaymentService\ServiceProvider\Provider\Stripe\Response;
 ...
 *
 * @package PaymentService\ServiceProvider\Provider\Stripe\Connector
 */
class StripeConnector extends RESTConnector
{
