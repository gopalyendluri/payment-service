...
namespace PaymentService\ServiceProvider\Provider\Braintree\Connector;

use PaymentService\ServiceProvider\Connector\RESTConnector;
use PaymentService\ServiceProvider\Provider\Braintree\Request;
use PaymentService\ServiceProvider\Provider\Braintree\Response;
 ...
 *
 * @package PaymentService\ServiceProvider\Provider\Braintree\Connector
 */
class BraintreeConnector extends RESTConnector
{
